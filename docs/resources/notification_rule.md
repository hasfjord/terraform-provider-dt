...
- `criteria` (Attributes) The criteria that needs to be met before the actions are executed. (see [below for nested schema](#nestedatt--trigger--criteria))
...
<a id="nestedatt--trigger--criteria"></a>
### Nested Schema for `trigger.criteria`

Optional:

- `connection` (String) The connection status of a device can be set to either `CONNECTION_CLOUD_CONNECTOR_OFFLINE`for cloud connector offline or `CONNECTION_SENSOR_OFFLINE` for sensor offline. Default is `CONNECTION_CLOUD_CONNECTOR_OFFLINE`
- `contact` (String) The open status of a contact(door and window) sensor. Must be one of `CONTACT_OPEN` or `CONTACT_CLOSED`. Default is CONTACT_OPEN
...
- `occupancy` (String) Occupancy detected by a sensor. Must be one of `OCCUPANCY_OCCUPIED` or `OCCUPANCY_NOT_OCCUPIED`. Default is OCCUPANCY_OCCUPIED
- `presence` (String) The presence of a object or person detected by a sensor. Must be one of `PRESENCE_PRESENT` or `PRESENCE_ABSENT`. Default is PRESENCE_PRESENT
- `range` (Attributes) The range of values that the data field has to be within or without for the criteria to be met. (see [below for nested schema](#nestedatt--trigger--criteria--range))

<a id="nestedatt--trigger--criteria--range"></a>
### Nested Schema for `trigger.criteria.range`
...
- `type` (String) The type of range to use. Must be one of `RANGE_TYPE_WITHIN` or `RANGE_TYPE_OUTSIDE`. Default is `RANGE_TYPE_WITHIN`.
...
- `type` (String) The type of notification action. Must be one of NOTIFICATION_ACTION_SMS,NOTIFICATION_ACTION_EMAIL,NOTIFICATION_ACTION_CORRIGO,NOTIFICATION_ACTION_SERVICE_CHANNEL,NOTIFICATION_ACTION_WEBHOOK,NOTIFICATION_ACTION_PHONE_CALL,NOTIFICATION_ACTION_SIGNAL_TOWER, default is NOTIFICATION_ACTION_EMAIL
